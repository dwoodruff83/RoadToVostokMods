...
FIXTURES = [
    ...
    },
    {
        ...
        "surface": "Metal",
        "light": {
            "type": "OmniLight3D", "color": (0.94, 0.78, 0.67),
            "energy": 0.25, "range": 1.0,
            "pos": (0, 0.1, 0), "down": False,
        },
    },
    {
        ...
        "light": {
            "type": "OmniLight3D", "color": (0.94, 0.78, 0.67),
            "energy": 0.75, "range": 4.0,
            "pos": (0, 0.15, 0), "down": False,
        },
    },
    {
        ...
        # inside the lampshade for the classic floor-lamp pool.
        "light": {
            "type": "SpotLight3D", "color": (1.0, 0.94, 0.86),
...
def light_node(light, name="Light"):
    ...
    # SpotLight3D defaults to shining in -Z. To aim down (-Y), rotate by
    # -90° X: basis becomes (1,0,0, 0,0,1, 0,-1,0). Otherwise identity.
    if light.get("down"):
...
[ext_resource type="Material" path="res://Modular/Materials/MT_Hint.tres" id="7"]
...
[node name="{name_caps}" type="Node3D"]
...
[node name="StaticBody3D" type="StaticBody3D" parent="Collider_R" groups=["Furniture"]]
collision_layer = 16
...
def render_tres(spec):
    ...
    trader_field = spec["trader"].lower()  # generalist / doctor / gunsmith / grandma
