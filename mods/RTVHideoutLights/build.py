#!/usr/bin/env python3
"""Package the RTV Hideout Lights mod into a .vmz archive.

Usage:
    python build.py                 # builds RTVHideoutLights.vmz next to this script
...
MOD_FILES = ['Main.gd', 'config.gd', 'Logger.gd', 'LightFurniture.gd', 'LightToggle.gd', 'LightStateStore.gd']
