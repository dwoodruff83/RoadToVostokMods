#!/usr/bin/env python3
"""Package the RTV Wallets mod into a .vmz archive.

Usage:
    python build.py                 # builds RTVWallets.vmz next to this script
        ...
        for asset_dir in ASSET_DIRS:
            ...
            for path in sorted(asset_root.rglob("*")):
                ...
                if "_1024" in path.name or "_1536x1024" in path.name or "_master" in path.name:
                    continue
                if path.suffix.lower() in {".blend", ".blend1", ".psd", ".xcf", ".backup", ".bak"}:
                    continue
