#!/usr/bin/env python3
"""Package the RTVModItemRegistry mod into a .vmz archive.

Usage:
    python build.py                 # builds RTVModItemRegistry.vmz next to this script
...
MOD_ID = "RTVModItemRegistry"
ROOT_FILES = ["mod.txt", "README.md", "CHANGELOG.md", "REGISTRY.md", "LICENSE"]
MOD_FILES = ["Main.gd", "config.gd", "Logger.gd", "DatabaseInject.gd"]
