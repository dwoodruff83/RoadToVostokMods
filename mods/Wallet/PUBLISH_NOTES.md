...
> - **This mod (Wallet)** — physical container items, three rarity tiers, lose-on-death-as-loot
>
...
Five toggles: Enable Wallet (master), Notify On Transfer, Enable Wallet, Enable Ammo Tin,
...
- [ ] Verify `mods/Wallet/build.py` builds: `publish.bat Wallet --no-open`
